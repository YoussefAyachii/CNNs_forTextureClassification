...
from set002_feat3_cnn_model import model


# Load trining and test data
dataset = np.load('database/feature_set002_feat3.npz')
...
plot_loss(train_history, savepath="figures/set002_feat3_model_history.png")
